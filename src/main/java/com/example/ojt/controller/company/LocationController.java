...
public class LocationController {
    ...
    public ResponseEntity<?> addLocation(@Valid @RequestBody LocationRequestDTO locationRequestDTO) throws CustomException {
        boolean check = locationService.saveOrUpdate(locationRequestDTO);
        if (check) {
    ...
    @PutMapping("")
    ResponseEntity<?> EditLocation(@Valid @RequestBody LocationRequestDTO locationRequestDTO) throws CustomException {
        boolean check = locationService.saveOrUpdate(locationRequestDTO);
        if (check) {
